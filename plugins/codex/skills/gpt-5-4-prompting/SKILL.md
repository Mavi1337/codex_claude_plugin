...
Use this skill when `codex:codex-rescue` needs to ask Codex for help, or when `codex-worker-development` composes an implementer brief for a selected 5.4-family model. Worker roles do not select a model.
