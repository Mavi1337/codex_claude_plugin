...
test("coordinator queues turns above the repository concurrency limit", async () => {
  ...
  await coordinator.startWorker({ workerId: "luna-1", orchestrationId: "orch-1", cwd, role: "luna" });
  await coordinator.startWorker({ workerId: "luna-2", orchestrationId: "orch-1", cwd, role: "luna" });
